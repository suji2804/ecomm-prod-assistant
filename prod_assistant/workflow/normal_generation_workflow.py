...
if __name__ == "__main__":
    try:
        ...
        # Assistant Answer:
        # I can see two iPhone 15 Pro Max models listed:

        # *   **Apple iPhone 15 Pro Max (White Titanium, 1 TB):** ₹1,08,999
        # *   **Apple iPhone 15 Pro Max (White Titanium, 512 GB):** ₹1,04,999
        #answer = invoke_chain("can you tell me the price of the iPhone 15?")
        #  Assistant Answer:
        #  I am an AI. I am designed to provide product recommendations and handle customer queries.
        print("\n Assistant Answer:\n", answer)
